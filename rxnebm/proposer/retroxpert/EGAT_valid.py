...
# test & train have been done as part of training
...
valid_dataloader = DataLoader(valid_data,
                                ...
                                num_workers=0,
                                collate_fn=collate)
test(GAT_model, valid_dataloader, data_split='valid', save_pred=True)
...
#                               num_workers=0,
#                               collate_fn=collate)
# test(GAT_model, train_dataloader, data_split='train', save_pred=True)
