...
input_folder = Path('data/USPTO50K/noncanonicalized_csv/')
output_folder = Path('data/USPTO50K/canonicalized_csv/')

for phase in ['train', 'valid', 'test']:
    input_csv_file = input_folder / f'{phase}.csv'
    output_csv_file = output_folder / f'{phase}.csv'
...
print('Done canonicalizing CSV files to remove info leak')