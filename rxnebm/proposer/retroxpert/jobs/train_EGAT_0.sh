...
python3 train.py --seed ${seed} --in_dim ${in_dim}

printf "running train.py with --test_only --load\n"
python3 train.py --test_only --load --seed ${seed} --in_dim ${in_dim}

printf "running train.py with --test_on_train --load\n"
python3 train.py --test_on_train --load --seed ${seed} --in_dim ${in_dim}
