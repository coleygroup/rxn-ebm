...
#SBATCH -J EGAT_20210423                            # name of job
...
python3 train.py --seed 20210423

printf "running train.py with --test_only --load\n"
python3 train.py --test_only --load --seed 20210423

printf "running train.py with --test_on_train --load\n"
python3 train.py --test_on_train --load --seed 20210423

# need seed bcos we are generating non-cano SMILES
printf "running prepare_data.py\n"
python3 prepare_data.py --seed 20210423

printf "running prepare_test_prediction.py\n"
python3 prepare_test_prediction.py --seed 20210423

printf "running prepare_train_error_aug.py\n"
python3 prepare_train_error_aug.py --seed 20210423
