...
#SBATCH -J proposevalid_20210423                          # name of job
...
python3 EGAT_valid.py --load --seed 20210423

printf "Running prepare_data_train_noaug.py\n"
python3 prepare_data_train_noaug.py --seed 20210423

printf "Running prepare_test_prediction_all.py\n"
python3 prepare_test_prediction_all.py --seed 20210423

printf "Running bash translate_valid.sh\n"
cd OpenNMT-py/script/USPTO50K-aug-untyped
bash translate_valid.sh 20210423

printf "Running score_valid.sh\n"
bash score_valid.sh 20210423