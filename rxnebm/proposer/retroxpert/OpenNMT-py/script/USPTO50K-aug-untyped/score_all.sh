...
# propose200, with seed
python3  ../../score_predictions.py  --beam_size 200 --invalid_smiles \
    --predictions  ../../experiments/results_${seed}/predictions_on_${dataset_prefix}_train-prediction_top200.txt \
...
python3  ../../score_predictions.py  --beam_size 200 --invalid_smiles \
    --predictions  ../../experiments/results_${seed}/predictions_on_${dataset_prefix}_test-prediction_top200.txt \
    --targets  ../../data/${dataset}/tgt-test.txt \
    --sources  ../../data/${dataset}/src-test.txt


# new args for proposing top200, without seed
# python3  ../../score_predictions.py  --beam_size 200 --invalid_smiles \
