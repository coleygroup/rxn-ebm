...
def scatter_max(src, index, dim=-1, out=None, dim_size=None, fill_value=0):
    ...
    return orig_smax(src, index, dim, out, dim_size)[0]     # by ztu on 201222, PTG API change
...
def scatter_min(src, index, dim=-1, out=None, dim_size=None, fill_value=0):
    ...
    return orig_smin(src, index, dim, out, dim_size)[0]     # by ztu on 201222, PTG API change
