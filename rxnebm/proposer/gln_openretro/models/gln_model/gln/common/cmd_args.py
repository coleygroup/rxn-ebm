...
cmd_opt.add_argument('-neg_sample', default='all', help='local/all')
...
cmd_opt.add_argument('-latent_dim', default=128, type=int, help='latent dim of gnn')
...
cmd_opt.add_argument('-max_lv', default=3, type=int, help='# layers of gnn') # vanilla is 3, try 4
...
cmd_opt.add_argument('-att_type', default='bilinear', help='mlp/inner_prod/bilinear')

cmd_opt.add_argument('-readout_agg_type', default='max', help='how to aggregate all node embeddings')
...
cmd_opt.add_argument('-act_func', default='relu', help='default activation function')
...
cmd_opt.add_argument('-fp_dim', default=2048, type=int, help='dim of fp') # vanilla is 2048, try 4096
...
cmd_opt.add_argument('-num_epochs', default=50, type=int, help='number of training epochs') 
