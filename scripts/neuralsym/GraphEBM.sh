...
python trainEBM.py \
  ...
  --do_get_energies_and_acc \
    --log_file 10x300_320_256x200_SYM_${ebm_seed}_1MPN_50top200max_bs4_2e4_fac80_pat1_stop3_f1e6_80ep_4GPU.log \
	--expt_name 10x300_320_256x200_SYM_${ebm_seed}_1MPN_50top200max_bs4_2e4_fac80_pat1_stop3_f1e6_80ep_4GPU \
