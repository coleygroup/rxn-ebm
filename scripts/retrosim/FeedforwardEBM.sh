...
python trainEBM.py \
  ...
  --do_get_energies_and_acc \
	--log_file 1024x128_128_SIM_${ebm_seed}_50top200max_lr1e3_wd0_fac20_pat0_stop2_40ep.log \
	--expt_name 1024x128_128_SIM_${ebm_seed}_50top200max_lr1e3_wd0_fac20_pat0_stop2_40ep \
    --proposals_csv_file_prefix "retrosim_200topk_200maxk_noGT" \
    --precomp_file_prefix "retrosim_rxn_fps_50topk_200maxk_16384_hybrid_all" \
