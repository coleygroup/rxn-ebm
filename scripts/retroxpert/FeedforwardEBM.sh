...
python trainEBM.py \
  ...
  --do_get_energies_and_acc \
	--log_file 1024x128_128_XPERT_${ebm_seed}_50top200max_lr1e3_fac20_pat0_stop2_40ep.log \
	--expt_name 1024x128_128_XPERT_${ebm_seed}_50top200max_lr1e3_fac20_pat0_stop2_40ep \
    --proposals_csv_file_prefix "retroxpert_200topk_200maxk_noGT_${xpert_seed}" \
    --precomp_rxnfp_prefix "retroxpert_${xpert_seed}_rxn_fps_50topk_200maxk_16384_hybrid_all" \
