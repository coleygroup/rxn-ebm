...
def trainEBM(args): 
    ...
    augmentations = {  # USER INPUT
        'rdm': {'num_neg': 5},  # pass in 'query_params': dict_of_query_params if desired. see nmslib docs for possible query parameters
...
def resumeEBM(args):
    ...
    precomp_file_prefix = '50k_' + expt_name # USER INPUT, expt.py will add f'_{phase}.npz'
    augmentations = { # USER INPUT 
        'rdm': {'num_neg': 0},
        'cos': {'num_neg': 0},
